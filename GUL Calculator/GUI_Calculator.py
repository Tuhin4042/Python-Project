...
class Calculator:
    def __init__(self,master):
        ...
        master.geometry("357x420+0+0") #weigth x hight
        master.config(bg="gray")
        master.resizable(False,False)
        
        self.equation=StringVar()
        self.entry_value=''
        Entry(width=17,bg="#fff",font=('Times new Roman',28),textvariable=self.equation).place(x=0,y=0)
        #Arial Bold
        ...
        Button(width=11,height=4,text='9',relief='flat',bg='white',command=lambda:self.show(9)).place(x=90 ,y=270)
    ...
    def solve(self):
        ...
        root = Tk()
        Calculator=Calculator(root) #write somwthings in the display
        root.mainloop()